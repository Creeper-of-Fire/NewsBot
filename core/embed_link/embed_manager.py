...
class EmbedLinkManager:
    ...
    def __init__(self, key: str, bot: 'NewsBot', default_embed: discord.Embed):
        """
    ...
    async def _save_configs(cls: Type[EmbedLinkManager]) -> None:
        ...
        async with cls._lock:
            ...
            await loop.run_in_executor(
                None,
                lambda: json.dump(cls.configs, open(CONFIG_FILE_PATH, 'w', encoding='utf-8'), indent=4, ensure_ascii=False)
            )
